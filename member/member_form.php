			        ...
			        <strong class="find_mem_ttl">회원가입</strong>
						<section class="renew_joinform_v2">
							...
							<div class="renew_input_box pw_chk">
                                ...
                                <input id="user_pwd" name="user_pwd" type="password" placeholder="비밀번호">
								<p class="limit_txt user_pwd_txt" id="user_pwd_txt"></p>
							</div>
							<div class="renew_input_box pw_chk bd_none">
								<label for="user_pwd_chk" class="hid">비밀번호확인</label>
                                <input type="password" id="user_pwd_chk" name="user_pwd_chk" placeholder="비밀번호 확인">
							</div>
						</section>
						<section class="renew_joinform_v2">
						...
						<section class="renew_joinform_v2 bdt_no">
							...
							<p class="btn_mem_login"><a href="javascript:void(0);">가입하기</a></p>
				</fieldset>	
			</form>
		</div>
	</div>
